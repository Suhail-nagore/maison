...
$recaptcha_secret = "6LcTi-gnAAAAAB6cyzhKYXiEyjIixXTCmpkyj_mi"; // Replace with your secret key
...
if (intval($responseKeys["success"]) !== 1) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        try {
            $stmt = $conn->prepare("INSERT INTO ContactForm1 (name,  email, contact_number, message) VALUES (:name,  :email, :contactNumber, :message)");
